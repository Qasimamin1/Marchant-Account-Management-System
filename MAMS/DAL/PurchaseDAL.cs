            ...
            using (_connection._connection)
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    if (reader.HasRows)
                    {
                        ...
                        {
                            _custType = new CustomerType();
                            _custType.UID = Convert.ToInt32(reader["UID"]);
                ...
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    if (reader.HasRows)
                    {
                        while (reader.Read())
                        {
                            ...
                            _purchase.AddDate = Convert.ToDateTime(reader["AddDate"].ToString()).ToString("dd-MM-yyyy", CultureInfo.InvariantCulture);
                            _purchase.Status = Convert.ToBoolean(reader["Status"].ToString());
                ...
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    if (reader.HasRows)
                    {
                        while (reader.Read())
                        {
                            ...
                            _purchase.Fk_CustomerId = Convert.ToInt32(reader["Fk_Customer"].ToString());
                ...
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    if (reader.HasRows)
                    {
                        while (reader.Read())
                        {
                            ...
                            _expense.AddBy =  reader["AddBy"].ToString();
                            _expense.AddDate = Convert.ToDateTime(reader["AddDate"].ToString()).ToString("dd-MM-yyyy", CultureInfo.InvariantCulture);
                            _expense.Status = Convert.ToBoolean(reader["Status"].ToString());
